sap.ui.define([
    ...
    return BaseController.extend("yslpmmyprb.controller.App", {
       ...
       */
        _getApplicationConfiguration: function (callback) {
            ...
            sharedLibrary.readEntityWithFilter("FrontendConfiguration", "Application eq 'yslpmmyprb'", sErroneousExecutionText, this, false, true, function (oData) {
