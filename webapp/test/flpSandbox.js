			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zslpmmyprb-display": {
								"semanticObject": "zslpmmyprb",
								"action": "display",
								"description": "zslpmmyprb",
								"title": "zslpmmyprb",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zslpmmyprb",
									"url": sap.ui.require.toUrl("zslpmmyprb")
								}
							}
						}
					}
